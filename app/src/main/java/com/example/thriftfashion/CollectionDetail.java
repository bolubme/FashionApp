    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CollectionDetail.this, Menu.class);
        ...
        imageSearch.setOnClickListener((new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CollectionDetail.this, Search.class);
                startActivity(intent);
            }
        }));
        ...
        imageBag.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CollectionDetail.this, cart.class);
                startActivity(intent);
            }
        });
    }
